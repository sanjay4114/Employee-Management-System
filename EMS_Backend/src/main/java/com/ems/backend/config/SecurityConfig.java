...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/departments/me", "/api/leaves/me").hasAnyRole("EMPLOYEE", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/leaves").hasAnyRole("EMPLOYEE", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/employees/**", "/api/departments/**").authenticated()
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/leaves/approve/**", "/api/leaves/reject/**").hasRole("ADMIN")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:3000", "http://localhost:5500", "http://localhost:5173", "http://127.0.0.1:5173"));
